...
import { addBlog, getBlogs, getBlogById,getBlogByUrl, deleteBlog,getBlogsFrontend, updateBlog,getRecentBlogs} from "../controllers/blog.controller.js";
...
router.route("/getRecentBlogs").get( getRecentBlogs);
